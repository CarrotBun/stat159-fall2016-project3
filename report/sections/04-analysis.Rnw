...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{../images/cv-ridge-mse-plot.png}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{../images/cv-lasso-mse-plot.png}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{../images/cv-pcr-mse-plot.png}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{../images/cv-pls-mse-plot.png}
